...
class Login extends Component {
  ...
  if(this.props.role != undefined){
    if(this.props.role == 'Domestic'){
      ...
      this.setState({menuValue:1,loginComponent:localloginComponent,loginRole:'Domestic'})
    }
      ...
      this.setState({menuValue:2,loginComponent:localloginComponent,loginRole:'Abroad'})
    }
  }
  }
  handleClick(event){
    ...
    return (
      <div>
        ...
        <DropDownMenu value={this.state.menuValue} onChange={(event,index,value)=>this.handleMenuChange(value)}>
          <MenuItem value={1} primaryText="Domestic" />
          <MenuItem value={2} primaryText="Foreigner" />
        </DropDownMenu>
        </div>
        </MuiThemeProvider>
